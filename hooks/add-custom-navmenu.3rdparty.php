<script type="text/javascript">
	$(document).ready(function() {
		...
		var newNavButtons = '<li><a a href="#" class="newNavButtons"><span aria-hidden="true" class="icon16 wpzoom-star" style="padding-right: 10px;"></span>'+newNavButtonsName+'<span class="hasDrop icon16 icomoon-icon-arrow-down-2"></span></a><ul class="navSub">'+newNavButtonsList+'</ul></li>';
