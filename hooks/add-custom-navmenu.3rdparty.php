<!-- This will create new button with submenu at the CWP's top nav menu -->

<script type="text/javascript">
	$(document).ready(function() {
		var newNavButtonsList = '';
		...
		var newNavButtons = '<li><a a href="#" class="newNavButtons"><span aria-hidden="true" class="icon16 wpzoom-star" style="padding-right: 10px;"></span>Custom Menu<span class="hasDrop icon16 icomoon-icon-arrow-down-2"></span></a><ul class="navSub">'+newNavButtonsList+'</ul></li>';
